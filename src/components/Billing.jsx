...
const Billing = () => (
  <section className={`${layout.sectionReverse}`}>
    ...
    <div className={`${layout.sectionInfo} flex flex-col`}>
      ...
      <div className={`flex flex-row flex-wrap sm:mt-5 mt-6`}>
        <img src={apple} alt="apple" className="w-[128px] h-[42px] object-contain mr-3 cursor-pointer"/>
        <img src={google} alt="google" className="w-[128px] h-[42px] object-contain mr-3 cursor-pointer"/>
      </div>
    </div>
