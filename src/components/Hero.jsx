...
const Hero = () =>  (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
      ...
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 `}>{/*  left */}
        ...
        <h1 className="font-poppins font-semibold ss:text-[69px] text-white
        text-[48px] ss:leading-[100px] leading-[75px] w-full">
            Payment Method
        </h1>
      ...
      <div className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 `}>
        ...
        className="w-full h-[100%] relative z-[5] object-contain" />
